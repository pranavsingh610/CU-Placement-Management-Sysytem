  ...
  <body>
    ...
    <div class="templatemo-flex-row">
      ...
      <div class="templatemo-content col-1 light-gray-bg">
          ...
          <div class="templatemo-content-widget white-bg">
            ...
            <form action="pref.php" class="templatemo-login-form" method="post" enctype="multipart/form-data">
              <div class="row form-group">
				...
				<div class="col-lg-6 col-md-6 form-group">
                  <label for="B">SSLC/10th Board</label>
                  <input type="text" name="Board" class="form-control" id="B" placeholder="">
                </div>
         <div class="col-lg-6 col-md-6 form-group">
        ...
        <div class="col-lg-6 col-md-6 form-group">
                  <label for="Bo">12th/Diploma Board</label>
                  <input type="text" name="Board12" class="form-control" id="Bo" placeholder="">
                </div>
