...
<body>
				...
				<div class="top-nav">
					...
					<ul class="nav1">
						<li class="hvr-sweep-to-bottom">
								<a href="../Homepage/index.php">University of Calcutta<i>Goto Placement Homepage</i></a>
							</li>
						<li class="hvr-sweep-to-bottom">
	...
	<div class="about-bottom">
		<!-- container -->
		<div class="container">
			<h3 class="wow fadeInRight animated" style="visibility: visible;">A New Generation of University of Calcutta</h3>
			<div class="about-bottom-grids">
				<div class="col-md-6 about-bottom-left wow fadeInLeft animated animated" data-wow-delay="0.5s" style="visibility: visible; -webkit-animation-delay: 0.5s;">
					<h4>What We Offer?</h4>
					<p>For engineering courses, admission is based on the West Bengal Joint Entrance Examination (WBJEE) rankings. While, for postgraduate courses and doctoral degree courses, one has to take an entrance exam/written test given by the university or any national level exam related to the subject, held by the UGC. A merit list is prepared on the basis of the results of the exams. 
					</p>
				</div>
	...
	<!-- footer -->
		<div class="footer">
			...
			<div class="container">
				...
				<div class="col-md-3 footer-right  wow fadeInRight animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					<h6 style="color: white">University of Calcutta</h6>
					<h4>
		...
		<div class="copyright">
			...
			<div class="container">
				...
				<p>Official Site, Copyright © 2004 </p>
					</p>
				</div>
