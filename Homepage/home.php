...
<html lang="en">
    ...
    <head>
        ...
        <!--favicon-->
        <link rel="shortcut icon" href="icon.jpeg" type="image/icon">
        <link rel="icon" href="icon.jpeg" type="image/icon">
        <title>PLacement CU Home</title>
        <!-- Bootstrap Core CSS -->
    ...
    <nav id="mainNav" class="navbar navbar-default navbar-fixed-top" style="background:black">
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    ...
                    <img class="navbar-brand page-scroll" src="images/CU.jpg">
                    <a class="navbar-brand page-scroll" href="https://www.caluniv.ac.in/?msclkid=51f14cf9c6f511ec84ed38cd1de89c1c">University of calcutta</a>
                </div>
        ...
        <div class="footer">
			<div class="container">
				...
				<div class="col-md-3 get_in_touch ftr">
					...
					<p>87/1, college street</p>
					<p>Kolkata-700073</p>
					<a href="mailto:sauryasuman01@gmail.com">sauryasuman01@gmail.com</a>
				</div>
